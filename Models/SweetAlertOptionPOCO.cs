  ...
  internal class SweetAlertOptionPOCO
    {
        ...
        [JsonPropertyName("allowEscapeKey")]
        public bool? AllowEscapeKey { get; set; }

        [JsonPropertyName("allowEnterKey")]
        ...
        [JsonPropertyName("showDenyButton")]
        ...
        [JsonPropertyName("denyButtonText")]
        ...
        [JsonPropertyName("denyButtonColor")]
        ...
        [JsonPropertyName("buttonsStyling")]
        public bool? ButtonsStyling { get; set; }

        [JsonPropertyName("reverseButtons")]
        public bool? ReverseButtons { get; set; }

        [JsonPropertyName("focusConfirm")]
        public bool? FocusConfirm { get; set; }

        [JsonPropertyName("focusDeny")]
        public bool? FocusDeny { get; set; }

        [JsonPropertyName("focusCancel")]
        ...
        [JsonPropertyName("inputAutoTrim")]
        public bool? InputAutoTrim { get; set; }

        [JsonPropertyName("inputAttributes")]
        public IDictionary<string, string> InputAttributes { get; set; }

        [JsonPropertyName("inputValidator")]
        ...
        [JsonPropertyName("didRender")]
        public bool DidRender { get; set; }

        [JsonPropertyName("scrollbarPadding")]
