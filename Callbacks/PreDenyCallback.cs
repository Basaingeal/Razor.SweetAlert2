namespace CurrieTechnologies.Razor.SweetAlert2
{
    ...
    public class PreDenyCallback
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PreDenyCallback"/> class.
        /// Creates a <see cref="PreDenyCallback"/> for the provided <paramref name="receiver"/> and <paramref name="callback"/>.
        ...
        public PreDenyCallback(Func<string, Task<string>> callback, ComponentBase receiver = null)
        {
        ...
        /// <param name="receiver">The event receiver. Pass in `this` from the calling component.</param>
        /// <exception cref="ArgumentException">Thrown if used in Queue request.</exception>
        public PreDenyCallback(Func<Task<string>> callback, ComponentBase receiver = null)
        {
        ...
        /// <param name="receiver">The event receiver. Pass in `this` from the calling component.</param>
        /// <exception cref="ArgumentException">Thrown if used in Queue request.</exception>
        public PreDenyCallback(Func<string, string> callback, ComponentBase receiver = null)
        {
        ...
        /// <param name="receiver">The event receiver. Pass in `this` from the calling component.</param>
        /// <exception cref="ArgumentException">Thrown if used in Queue request.</exception>
        public PreDenyCallback(Func<string> callback, ComponentBase receiver = null)
        {
        ...
        public PreDenyCallback(Func<IEnumerable<string>, Task<IEnumerable<string>>> callback, ComponentBase receiver = null)
        {
        ...
        /// <param name="receiver">The event receiver. Pass in `this` from the calling component.</param>
        /// <exception cref="ArgumentException">Thrown if used in Fire request.</exception>
        public PreDenyCallback(Func<Task<IEnumerable<string>>> callback, ComponentBase receiver = null)
        {
        ...
        /// <param name="receiver">The event receiver. Pass in `this` from the calling component.</param>
        /// <exception cref="ArgumentException">Thrown if used in Fire request.</exception>
        public PreDenyCallback(Func<IEnumerable<string>, IEnumerable<string>> callback, ComponentBase receiver = null)
        {
        ...
        /// <param name="receiver">The event receiver. Pass in `this` from the calling component.</param>
        /// <exception cref="ArgumentException">Thrown if used in Fire request.</exception>
        public PreDenyCallback(Func<IEnumerable<string>> callback, ComponentBase receiver = null)
        {
